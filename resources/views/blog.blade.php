                    ...
                    <div class="col-lg-12 col-md-12 align-items-center m-auto padd" >
                        <div class="row">
                            <div class="hero-content-wrap">
                                <h1 class="fw-bold display-5 text-white mt-5">Our Blog</h1>
                                <p>Read our blogs</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-5 col-md-12">
                        <div class="single-article feature-article rounded-custom my-3">
                            ...
                            <a href="" class="article-img">
                                <img src="{{asset('uploads/posts/'.$user['avatar'])}}" alt="article"  class="img-fluid">
                            </a>
                            
                            <div class="article-content p-4">
                                <div class="article-category mb-4 d-block">
                                    <a href="javascript:;" class="d-inline-block text-dark badge bg-primary-soft">Collision</a>
                                </div>
                               
                                <a href="{{ route('blog_single',$user->id) }}">
                                    <h2 class="h5 article-title limit-2-line-text">{!!$user->title!!} </h2>
                                </a>
                            
                              
                                <!-- <p class="limit-2-line-text">{!!$user->discription!!}</p> -->
                                ...
                                <a href="javascript:;">
                                    <div class="d-flex align-items-center pt-4">
                                        ...
                                        <div class="avatar-info">
                                            <h6 class="mb-0 avatar-name">{!!$user->sub_title!!}</h6>
                                            <span class="small fw-medium text-muted">{!!$user->dob!!}</span>
                                        </div>
                                    </div>
                                </a>
