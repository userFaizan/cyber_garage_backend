                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="needs-validation" action="{{ route('user_edit') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                        ...
                                        <input type="hidden" name="id" value="{{$data['id']}}">
                                             ...
                                             <div class="form-group">
                                                 ...
                                                 <input type="text" class="form-control flatpickr-validation flatpickr" name="title"   value="{{$data['title']}}" required />
                                         ...
                                         <div class="col-lg-6 col-md-6 col-sm-6">
                                             ...
                                             <div class="form-group">
                                                 ...
                                                 <input type="text" class="form-control flatpickr-validation flatpickr" name="sub_title" value="{{$data['sub_title']}}" required />
                                                 {{-- <div class="valid-feedback">Looks good!</div>
                                                 <div class="invalid-feedback">Please Enter Your DOB</div> --}}
                                             </div>
                                         </div>
                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control flatpickr-validation flatpickr" name="dob"  value="{{$data['dob']}}" required />
                                                {{-- <div class="valid-feedback">Looks good!</div>
                                                <div class="invalid-feedback">Please Enter Your DOB</div> --}}
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input" id="customFile1" value="{{$data['avatar']}}" name="avatar" />
                                        ...
                                        <div class="form-group">
                                            <label class="d-block" for="comment">About</label>
                                            <textarea class="form-control" rows="3" id="summernote" name="discription" value="" required>{{ $data['discription'] }}</textarea>
                                        </div>
