          ...
          <div class="box-body">
            <form method="post" action="{{ route('user_edit') }}" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input type="name" name="title" class="form-control"  value="{{$data['title']}}" id="exampleInputEmail1" placeholder="Enter Tag">
              </div>
              <div class="form-group">
                <label for="exampleInputName1">Sub_Title</label>
                <input type="name" name="sub_title" class="form-control"  value="{{$data['sub_title']}}" id="exampleInputEmail1" placeholder="Enter Name">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <textarea class="form-control " rows="3"  name="discription" required>{{ $data['discription'] }}</textarea>
