      ...
      <div class="col-md-6">
        <div class="box">
          <div class="box-header">
            <h2>Edit Video Page Section # 2</h2>
          ...
          <div class="box-body">
            <form method="post" action="{{ route('update.video') }}" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="id" class="form-control"   value="{{ $data->id }}"id="" placeholder="Enter Title # 1">
                            ...
                            <div class="form-group">
                                <label for="exampleInputName1">Choose Video # 1</label>
                                <input type="text" name="file_1"  class="form-control" value="{{ $data->file_1 }}" placeholder="Enter video Url">
                              </div>
