      ...
      <div class="col-md-6">
        <div class="box">
          <div class="box-header">
            <h2>Edit Management Section # 2</h2>
          ...
          <div class="box-body">
            <form method="post" action="{{ route('management.update.2') }}" enctype="multipart/form-data" >
                @csrf
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control ckeditor " rows="1"  name="para"  required>{{$data['para']}}</textarea>
                            </div> 
                            <div class="form-group">
