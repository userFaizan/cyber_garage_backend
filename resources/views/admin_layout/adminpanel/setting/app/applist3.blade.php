            ...
            <table  class="table m-b-none myTable" ui-jp="footable" data-filter="#filter" data-page-size="5">
              ...
              <tbody>
                ...
                <tr>
                    ...
                    <td> 
                       <a href="{{route('app.3.edit', $app->id)}}"><span><i class="fa-solid fa-pen"></i></span></a>
                       <a href="{{route('app.3.destroy', $app->id)}}"><span><i class="fa-solid fa-trash"></i></span></a>
                    </td>
                </tr>
                @endforeach
              </tbody>
