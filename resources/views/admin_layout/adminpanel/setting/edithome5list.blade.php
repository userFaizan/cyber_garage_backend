      ...
      <div class="col-md-6">
        <div class="box">
          <div class="box-header">
            <h2>Edit List items Home Section # 5</h2>
          ...
          <div class="box-body">
            <form method="post" action="{{ route('list.5.update') }}">
                @csrf
                             <input type="hidden" name="id" value="{{$data['id']}}">
                             <div class="form-group">
                              <label for="exampleInputName1">List Item</label>
                              <input type="name" name="list_item" class="form-control"   value="{{$data['list_item']}}" id="" placeholder="Enter List Items">
                            </div>
