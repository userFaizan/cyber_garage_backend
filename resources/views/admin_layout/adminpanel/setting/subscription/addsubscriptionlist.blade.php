      ...
      <div class="col-md-6">
        <div class="box">
          <div class="box-header">
            <h2>Add List items Subscritons Section # 1</h2>
          ...
          <div class="box-body">
            <form method="post" action="{{ route('subscriton.1.add') }}">
                @csrf
                             {{-- <input type="hidden" name="id" value="{{$data['id']}}"> --}}
                             <div class="form-group">
                              <label for="exampleInputName1">List Item</label>
                              <input type="name" name="list_title" class="form-control" id="" placeholder="Enter List Items">
                            </div>
