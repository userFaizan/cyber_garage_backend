            ...
            <table  class="table m-b-none myTable" ui-jp="footable" data-filter="#filter" data-page-size="5">
              ...
              <tbody>
                ...
                <tr>
                    ...
                    <td> 
                       <a href="{{route('privacy.4.edit', $privacy->id)}}"><span><i class="fa-solid fa-pen"></i></span></a>
                       <a href="{{route('privacy.4.destroy', $privacy->id)}}"><span><i class="fa-solid fa-trash"></i></span></a>
                    </td>
                </tr>
                @endforeach
              </tbody>
