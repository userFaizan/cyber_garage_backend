      ...
      <div class="col-md-6">
        <div class="box">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
              <label class="d-block">Section # 6</label>
          ...
          <div class="form-group">
            ...
            <div class="form-group">
              <label class="d-block">Section # 14</label>
          ...
          <div class="form-group">
            ...
            <div class="form-group">
              ...
              <textarea class="form-control ckeditor " rows="3"  name="sub_title15"  required>{{ $data['sub_title15'] }}</textarea>
          </div>
          <div class="form-group">
              <label for="exampleInputName1">Title # 16</label>
              <input type="name" name="title16" class="form-control"  value="{{$data['title16']}}"  value="" id="" placeholder="Enter Title # 16">
            </div>

            <div class="form-group">
              <label class="d-block">Section # 16</label>
              <textarea class="form-control ckeditor " rows="3"  name="sub_title16"  required>{{ $data['sub_title16'] }}</textarea>
          </div>
          <div class="form-group">
