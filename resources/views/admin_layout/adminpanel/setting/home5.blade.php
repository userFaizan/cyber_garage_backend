    ...
    <div class="row justify-content-center pt-5">
      <div class="col-md-6">
        <div class="box">
          ...
          <div class="box-body">
            <form method="post" action="{{ route('home.update.5') }}" enctype="multipart/form-data">
                @csrf
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                <label for="exampleInputName1">Choose Section # 5 Image</label>
