                        ...
                        <div class="row">
                            <div class="col-lg-12 m-auto padd">
                                <div class="hero-content-wrap">
                                    <h1 class="fw-bold display-5 mt-5 text-white">Management Information</h1>
                    ...
                    <div class="col-lg-7 col-sm-12 padd">
                        <div class="col-lg-10 p-0 m-0 mr-auto padd-2">
                            <div class="why-choose-content">
                                <h2>Not all collision repair management systems are created equal</h2>
                ...
                <div class="row justify-content-lg-between align-items-center">
                    <div class="col-lg-7 col-sm-12">
                        <div class="col-lg-12 p-0 m-0 m-auto padd">
                            <div class="why-choose-content m-0 padd-2">
                                <h2 class="text-white">The significance of monitoring KPI</h2>
                                <p class="text-white">Your KPIs give you a thorough assessment of your company’s past performance and future growth potential. Based on the data you gather and analyze, KPIs help you translate your business plan into manageable, operational actions.</p>
                    ...
                    <div class="col-lg-5 col-12">
                        <div class="feature-img-holder">
                            <img src="assets/img/xss.png" class="img-fluid" alt="feature-image">
                        </div>
                    </div>
                </div>
                <div class="row">
